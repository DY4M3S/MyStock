 ...
 * @author Jason
 */
public class GerenciarVendas extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerenciarVendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
