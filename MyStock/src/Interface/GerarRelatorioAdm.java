 ...
 * @author Jason
 */
public class GerarRelatorioAdm extends javax.swing.JFrame {

    /**
     * Creates new form GerarRelatorio
     */
    public GerarRelatorioAdm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Pedido", "Nome do produto", "Quantidade de itens", "Valor total do pedido", "Valor total das vendas"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerarRelatorioAdm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
