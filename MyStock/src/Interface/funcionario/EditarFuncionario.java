...
public class EditarFuncionario extends javax.swing.JFrame {
        private ListarFuncionario tela;
    ...
    public EditarFuncionario(ListarFuncionario tela,Funcionario f) {
        this.tela = tela;
        this.f = f;
        initComponents();
        trazerDadosFuncionario();
    }
    ...
    private void trazerDadosFuncionario(){
        this.inputNome.setText(f.getNome());
        this.inputCpf.setText(f.getCpf());
        this.inputEmail.setText(f.getEmail());
        this.inputTelefone.setText(String.valueOf(f.getTelefone()));
        this.inputEndereco.setText(f.getEndereco());
        this.inputNumero.setText(String.valueOf(f.getNumero()));
        this.inputBairro.setText(f.getBairro());
        this.inputCidade.setText(f.getCidade());
        this.inputUf.setText(f.getUf());
        this.inputSenhaAcesso.setText(f.getSenha());
    ...
    private void initComponents() {
        ...
        DivEditarFuncionario = new javax.swing.JPanel();
        ...
        DivBotoesEditarFuncionario = new javax.swing.JPanel();
        ...
        DivEditarFuncionario.setBackground(new java.awt.Color(255, 255, 255));
        ...
        DivBotoesEditarFuncionario.setBackground(new java.awt.Color(255, 255, 255));
        DivBotoesEditarFuncionario.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        javax.swing.GroupLayout DivBotoesEditarFuncionarioLayout = new javax.swing.GroupLayout(DivBotoesEditarFuncionario);
        DivBotoesEditarFuncionario.setLayout(DivBotoesEditarFuncionarioLayout);
        DivBotoesEditarFuncionarioLayout.setHorizontalGroup(
            DivBotoesEditarFuncionarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(DivBotoesEditarFuncionarioLayout.createSequentialGroup()
                .addGap(0, 70, Short.MAX_VALUE)
                .addGroup(DivBotoesEditarFuncionarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(DivBotoesEditarFuncionarioLayout.createSequentialGroup()
                    ...
                    .addGroup(DivBotoesEditarFuncionarioLayout.createSequentialGroup()
                        ...
                        .addGroup(DivBotoesEditarFuncionarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(DivBotoesEditarFuncionarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(DivBotoesEditarFuncionarioLayout.createSequentialGroup()
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, DivBotoesEditarFuncionarioLayout.createSequentialGroup()
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, DivBotoesEditarFuncionarioLayout.createSequentialGroup()
                                    .addGroup(DivBotoesEditarFuncionarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        DivBotoesEditarFuncionarioLayout.setVerticalGroup(
            DivBotoesEditarFuncionarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(DivBotoesEditarFuncionarioLayout.createSequentialGroup()
                .addGap(0, 24, Short.MAX_VALUE)
                .addGroup(DivBotoesEditarFuncionarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        javax.swing.GroupLayout DivEditarFuncionarioLayout = new javax.swing.GroupLayout(DivEditarFuncionario);
        DivEditarFuncionario.setLayout(DivEditarFuncionarioLayout);
        DivEditarFuncionarioLayout.setHorizontalGroup(
            DivEditarFuncionarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, DivEditarFuncionarioLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(DivBotoesEditarFuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        DivEditarFuncionarioLayout.setVerticalGroup(
            DivEditarFuncionarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, DivEditarFuncionarioLayout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(DivEditarFuncionario, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        ...
        isFieldEmpty(uf) || isFieldEmpty(senha)){
            JOptionPane.showMessageDialog(this, "Funcionário tem que apresentar todos campos preenchidos!");
            trazerDadosFuncionario();
        } else {
        int confirmar = JOptionPane.showConfirmDialog(this, "Você realmente deseja alterar os dados deste funcionário?",
                "Confirmar alteração",
                JOptionPane.YES_NO_OPTION);    
            
            if (confirmar == JOptionPane.YES_OPTION) {
                this.f.setNome(this.inputNome.getText());
                this.f.setCpf(this.inputCpf.getText());
                this.f.setEmail(this.inputEmail.getText());
                this.f.setTelefone(telefone);
                this.f.setEndereco(this.inputEndereco.getText());
                this.f.setNumero(numero);
                this.f.setBairro(this.inputBairro.getText());
                this.f.setCidade(this.inputCidade.getText());
                this.f.setUf(this.inputUf.getText());
                this.f.setSenha(this.inputSenhaAcesso.getText());
    ...
    private javax.swing.JPanel DivBotoesEditarFuncionario;
    private javax.swing.JPanel DivEditarFuncionario;
