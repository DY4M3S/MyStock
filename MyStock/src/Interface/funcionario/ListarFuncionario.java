...
public class ListarFuncionario extends javax.swing.JFrame {
    ...
    public void atualizar() {
        ...
        model.addAll(Repositorio.funcionario);
        this.DivLista.setModel(model);
    }
    
    private void excluirFuncionario(int confirmacao, Object objeto){
        
        if (confirmacao == JOptionPane.YES_OPTION) {
            Funcionario f = (Funcionario) objeto;
            Repositorio.funcionario.remove(f);
            this.atualizar();
        }
    }
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        int confirmacao = JOptionPane.showConfirmDialog(this,
            ...
            excluirFuncionario(confirmacao, objeto);
        }
    ...
    private void botaoEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEditarActionPerformed
        ...
        if (objeto != null) {
            Funcionario f = (Funcionario) objeto;
            new EditarFuncionario(this, f).setVisible(true);
            this.dispose();
        }
